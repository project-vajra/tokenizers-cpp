...
class Tokenizer {
 public:
  ...
  /*!
   * \brief Encode text into ids with option to add special tokens.
   * \param text The input text.
   ...
   * \param skip_special_tokens Whether to omit special tokens (added tokens
   *        flagged `special`) from the decoded text.
